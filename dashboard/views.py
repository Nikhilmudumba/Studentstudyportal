...
def notes(request):
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            notes.save()
        messages.success(request,f"Ntes Added from {request.user.username} Successfully")
    else:
        form=NotesForm()
...
def todo(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            todos.save()
            messages.success(request,f'Todo has been successfully from {request.user.username}')
    else:
        form=TodoForm()
